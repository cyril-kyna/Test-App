    ...
    <div className="flex flex-col gap-10 mt-28">
      ...
      <div className="flex flex-row items-start gap-20">
        <div className="flex flex-col gap-2">
          <h1 className="text-[var(--grey-white)] text-left text-[1.5rem] font-[700] text-balance uppercase">
            Set Pay Rate
          </h1>
          <Formik
        ...
        <div className="flex flex-col min-w-96 gap-2">
          <div className="flex flex-row justify-between items-center">
            <h1 className="text-[var(--grey-white)] text-left text-[1.5rem] font-[700] text-balance uppercase">Payment Records</h1>
            <Popover>
